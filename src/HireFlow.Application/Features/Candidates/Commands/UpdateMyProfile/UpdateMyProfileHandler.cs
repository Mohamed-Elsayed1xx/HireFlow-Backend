...
public class UpdateMyProfileHandler : IRequestHandler<UpdateMyProfileCommand, Result<CandidateDto>>
{
    private readonly ICandidateRepository _candidateRepository;
    private readonly ICurrentUserService _currentUser;

    public UpdateMyProfileHandler(ICandidateRepository candidateRepository, ICurrentUserService currentUser)
    {
        _candidateRepository = candidateRepository;
        _currentUser = currentUser;
    }

    public async Task<Result<CandidateDto>> Handle(UpdateMyProfileCommand request, CancellationToken cancellationToken)
    {
